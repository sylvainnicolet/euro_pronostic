 ...
 */
final class Version20210602080412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT NOT NULL, name VARCHAR(255) NOT NULL, groupe INT NOT NULL, PRIMARY KEY(id))');
